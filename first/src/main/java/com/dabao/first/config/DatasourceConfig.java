package com.dabao.first.config;
...
@Configuration
//扫描 Mapper 接口,动态代理创建其实现类，注入spring容器，替代mybatis的工作
@MapperScan(basePackages = DatasourceConfig.PACKAGE, sqlSessionFactoryRef = "sqlSessionFactory")
public class DatasourceConfig {
	// 精确到 master 目录，以便跟其他数据源隔离
    static final String PACKAGE = "com.dabao.first.mapper";
    ...
    public SqlSessionFactory ds1SqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
        ...
        sessionFactory.setTypeAliasesPackage("com.dabao.entity");
